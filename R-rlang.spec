...
Version  : 1.1.2
Release  : 91
URL      : https://cran.r-project.org/src/contrib/rlang_1.1.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rlang_1.1.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699289844
