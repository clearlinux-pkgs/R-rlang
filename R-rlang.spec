...
Version  : 0.3.2
Release  : 36
URL      : https://cran.r-project.org/src/contrib/rlang_0.3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rlang_0.3.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1553192085
