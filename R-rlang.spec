...
Version  : 0.3.4
Release  : 38
URL      : https://cran.r-project.org/src/contrib/rlang_0.3.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rlang_0.3.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554649404
