...
Source0  : https://cran.r-project.org/src/contrib/rlang_0.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572107552
...
/usr/lib64/R/library/rlang/tests/testthat/test-cnd-bullets-lazy.txt
